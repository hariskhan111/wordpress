...
function unite_widgets_init() {
	...
	register_widget( 'unite_films_posts_widget' );
	
    register_widget( 'unite_social_widget' );
	//register_widget( 'unite_films_widget' );
...
include(get_template_directory() . "/inc/widgets/films-posts-widget.php");
...
function unite_scripts() {
	...
	wp_enqueue_style( 'unite-icons', get_template_directory_uri().'/inc/css/ihovercss/hover.css' );
	wp_enqueue_style( 'unite-icons', get_template_directory_uri().'/inc/css/ihovercss/ihover.css' );
	wp_enqueue_style( 'unite-icons', get_template_directory_uri().'/inc/css/ihovercss/ihover.min.css' );
