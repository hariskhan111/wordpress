...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
        ...
        <?php
			...
			$ticket_price = get_field( "ticket_price", $id->ID );
			$release_date = get_field( "release_date", $id->ID );
			$country = get_field( "country", $id->ID );
            ?>
            <div class="single_post_careers pull-width pull-left">
			...
			// vars
			$field = get_field_object("country", $id->ID );
			$value = $field['value'];
			$label = $field['choices'][ $value ];
			
			?>
            <strong>Release In:</strong> <span class="color-<?php echo $value; ?>"><?php echo $label; ?></span>
			</h4>
            
            </li>
            <li>
            <h4><strong>Ticket Price </strong>$:<?php echo $ticket_price;?></h4>
            </li>
            <li>
            <h4><strong>Release date:</strong> <?php echo $release_date;?></h4>
            </li>
